<header>
    <div class="top-nav container d-flex flex-column flex-lg-row text-center text-lg-left justify-content-between py-2">
        <div class="logo"><a href="/">Laravel Example</a></div>
