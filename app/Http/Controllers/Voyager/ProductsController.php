...
class ProductsController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allCategory', 'categoriesForProduct'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // delete the product from categoryProduct pivot table
